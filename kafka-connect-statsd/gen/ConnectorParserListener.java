...
public interface ConnectorParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ConnectorParser#name}.
	 * @param ctx the parse tree
	 */
	void enterName(ConnectorParser.NameContext ctx);
	/**
	 * Exit a parse tree produced by {@link ConnectorParser#name}.
	 * @param ctx the parse tree
	 */
	void exitName(ConnectorParser.NameContext ctx);
}